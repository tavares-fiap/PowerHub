...
public class Splash_GUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        progressBar.setForeground(new java.awt.Color(39, 222, 175));
        jPanel1.add(progressBar);
        progressBar.setBounds(60, 380, 280, 14);
        ...
        message_lbl.setText("jLabel2");
        jPanel1.add(message_lbl);
        message_lbl.setBounds(60, 400, 280, 15);

        jLabel2.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/PowerHub_Character.png"))); // NOI18N
        jPanel1.add(jLabel2);
        jLabel2.setBounds(0, 150, 420, 340);

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/PowerHub_SplashGif.gif"))); // NOI18N
        jPanel1.add(jLabel1);
        jLabel1.setBounds(0, -6, 400, 710);
